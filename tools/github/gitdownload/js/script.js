    ...
    function upadateDownloadStatus(progress) {
        ...
        switch (progress.Status) {
            ...
            case 1:
                ...
                $("#status-msg").text("⌛-Checking The URL . . .");
                $("#err-msg").text(" ");
                break;
            case 2:
                $("#status-img").html(loadingImg);
            ...
            case 4:
                $("#status-img").html(loadingImg);
                $("#status-msg").text("✔️-Downloading files . . . " + progress.downloadedFiles + " / " + progress.totalFiles);
                $("#err-msg").text(" ");
                break;
            case 5:
                $("#status-img").html(loadingImg);
                $("#status-msg").text("✔️-Generating Zip file . . .");
                $("#err-msg").text(" ");
                break;
            case 6:
                $("#status-img").html(loadingImg);
                $("#status-msg").text("✔️-Saving Zip file . . .");
                $("#err-msg").text(" ");
                break;
            case 7:
                $("#status-img").html(downloadCompleteImg);
                $("#status-msg").text("☑️-Download Complete, Plz Check Your Downloads Folder.");
                $("#err-msg").text(" ");
                break;
            case -1:
